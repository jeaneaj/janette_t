...
import tooltwist.janette.productionHelpers.ContactNumberListProductionHelper;
 ...
 * Contact Number List
 */
public class ContactNumberListWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "contactNumberList_preview.html";
	private static final String SNIPPET_DESIGN = "contactNumberList_design.html";
	private static final String SNIPPET_PRODUCTION = "contactNumberList_production.jsp";
...
//		instance.defineProperty(new WbdStringProperty("myProperty", null, "My Property", ""));
 	instance.defineProperty(new WbdNavPointProperty("contactNumber", null, "Contact Number", ""));
	}
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator,instance, "contactNumberList_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator,instance, "contactNumberList_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ContactNumberListProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(ContactNumberListProductionHelper.class.getName()));
			}
		}
...
//		String myProperty = instance.getProperty("myProperty", null);
 String contactNumber = instance.getProperty("Contact Number", null);
		SnippetParam[] params = {
//			new SnippetParam("myProperty", myProperty),
 	new SnippetParam("contactNumber", contactNumber)
		};
		return params;
	}
}
