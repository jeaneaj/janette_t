...
//import tooltwist.janette.productionHelpers.LinkProductionHelper;
...
public class LinkWidget extends WbdWidgetController
{
	...
	protected void init(WbdWidget instance) throws WbdException
	{
		...
		instance.defineProperty(new WbdRadioTextProperty("target", null, "Target", "Yes, No", ""));
...
//				// Link to an external Javascript file
 	...
 	new JavascriptLinkInserter("ttsvr/janette/script/js/temp.js"),
...
//				codeInserterList.add(new PageImportCodeInserter(LinkProductionHelper.class.getName()));
	...
	public void renderForDesigner(WbdGenerator generator, WbdWidget instance, UimData ud, WbdRenderHelper rh) throws WbdException
	{
	 rh.renderSnippetForStaticPage(generator, instance, SNIPPET_DESIGN, getSnippetParams(generator, instance, ud));
		//rh.append(instance.getProperty("label", null));
	}
