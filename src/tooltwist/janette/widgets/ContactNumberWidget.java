...
import tooltwist.janette.productionHelpers.ContactNumberProductionHelper;
 ...
 * Contact Number
 */
public class ContactNumberWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "contactNumber_preview.html";
	private static final String SNIPPET_DESIGN = "contactNumber_design.html";
	private static final String SNIPPET_PRODUCTION = "contactNumber_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator,instance,"contactNumber_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator,instance,"contactNumber_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ContactNumberProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(ContactNumberProductionHelper.class.getName()));
			}
		}
