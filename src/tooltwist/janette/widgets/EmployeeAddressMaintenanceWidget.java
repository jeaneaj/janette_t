...
import tooltwist.janette.productionHelpers.EmployeeAddressMaintenanceProductionHelper;
 ...
 */
public class EmployeeAddressMaintenanceWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "employeeAddressMaintenance_preview.html";
	private static final String SNIPPET_DESIGN = "employeeAddressMaintenance_design.html";
	private static final String SNIPPET_PRODUCTION = "employeeAddressMaintenance_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator,instance, "employeeAddressMaintenance_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator,instance, "employeeAddressMaintenance_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, EmployeeAddressMaintenanceProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(EmployeeAddressMaintenanceProductionHelper.class.getName()));
			}
		}
	...
	{
		return "Employee Address Maintenance";
	}
